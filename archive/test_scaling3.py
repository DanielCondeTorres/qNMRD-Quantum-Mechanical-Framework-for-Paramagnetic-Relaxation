...
def simulate_T1(r_dist, tau_c, t_max=100000.0):
    ...
    try:
        popt, _ = curve_fit(exp_saturation, t_values, prob_excited, p0=[0.5, t_max/10], bounds=([0.0, 0.1], [1.0, t_max*100]))
        return popt[1]
    except:
        return None
...
t1_vals = []
for r in r_vals:
    t1 = simulate_T1(r, 20.0, t_max=200000.0)
